...
export default function PICMSPage() {
  ...
  const v2Features = [
    { icon: '⚡', title: 'Lightning Fast', description: 'React 18 with optimized rendering and real-time updates' },
    { icon: '🤖', title: 'AI Agents', description: 'Gap analysis, document review, and policy generation' },
    { icon: '📊', title: 'Real-Time Dashboards', description: 'Calendar widgets, notifications, and quick actions' },
    { icon: '📋', title: '16 Audit Templates', description: 'CDM and ISO standards coverage' },
    { icon: '📄', title: 'Document Workflows', description: 'Version history, approvals, and expiry tracking' },
    { icon: '🏗️', title: 'Construction Module', description: 'Site diaries, permits, and toolbox talks' },
  ];

  const powerfulFeatures = [
    { title: 'ISO Business Manual', description: 'Annex SL clause management with document linking' },
    { title: 'Multi-Standard ISO Support', description: 'ISO 9001, 14001, 45001, 27001 with UK guidance' },
    { title: 'Incident Reporting', description: 'Mobile capture with photos, RIDDOR assessment, investigation tracking' },
    { title: 'Smart Document Control', description: 'QMS numbering, version control, expiry tracking' },
    { title: 'Mobile Audit Forms', description: 'Field audits with photos, signatures, real-time submission' },
    { title: 'Risk Management', description: 'ISO clause linking, severity tracking, mitigation monitoring' },
    { title: 'Training Records', description: 'Certification tracking and automated expiry alerts' },
    { title: 'UK Legal Register', description: '170+ UK regulations with compliance tracking' },
    { title: 'Team Collaboration', description: 'Role-based access, invitations, activity feeds' },
    { title: 'Analytics & Reporting', description: 'Real-time dashboards, completion tracking, exportable reports' },
    { title: 'CAPA Management', description: 'Corrective/Preventive Action tracking with root cause analysis' },
    { title: 'Enterprise Security', description: 'AES encryption, audit logs, UK data residency' },
  ];

  const accreditations = [
    {
      name: 'CHAS',
      subtitle: 'Health & Safety Accreditation',
      features: ['12 Core Requirements Tracking', 'Document Mapping & Approval', 'Expiry Alerts & Reminders', 'Compliance Progress Dashboard'],
      color: 'from-blue-500 to-blue-600',
    },
    {
      name: 'SafeContractor',
      subtitle: 'Contractor Prequalification',
      features: ['15 Prequalification Requirements', 'Insurance & Policy Tracking', 'Modern Slavery Compliance', 'Subcontractor Management'],
      color: 'from-emerald-500 to-emerald-600',
    },
    {
      name: 'Constructionline',
      subtitle: 'PAS 91 Compliance',
      features: ['18 PAS 91 Requirements', 'Gold/Silver/Bronze Tier Tracking', 'Financial & H&S Evidence', 'Accident Statistics (AFR/AIR)'],
  ...
  const pricing = [
    {
      ...
      addons: ['Construction Pack (+£45)', 'Additional Admin (+£10)'],
    ...
    },
    {
      name: 'Principal',
      price: 495,
      description: 'White-glove service with auditor support',
      features: [
        'Everything in Enterprise',
        'Unlimited Users',
        'Quarterly Desktop Review',
        'IRCA Principal Auditor',
        'Pre-Audit Readiness Reports',
        'RAG Status Assessment',
        '500,000 API calls/month',
        '24/7 Priority Support',
        'Construction Pack Included',
      ],
      addons: [],
      cta: 'Contact Sales',
      featured: false,
